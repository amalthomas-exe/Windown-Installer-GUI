...
# Form implementation generated from reading ui file 'licenseAgreementPage.ui'
#
...
"}")
        ...
        self.label.setStyleSheet("background-image: url(:/newPrefix/win11.png);")
        self.label.setText("")
        self.label.setPixmap(QtGui.QPixmap(":/newPrefix/win11.png"))
        self.label.setScaledContents(True)
        self.label.setObjectName("label")
        self.label_2 = QtWidgets.QLabel(Dialog)
        self.label_2.setGeometry(QtCore.QRect(90, 40, 261, 41))
        font = QtGui.QFont()
...
"}")
        ...
        self.scrollArea.setGeometry(QtCore.QRect(40, 130, 551, 341))
...
"}")
        ...
        self.scrollAreaWidgetContents.setGeometry(QtCore.QRect(0, 0, 520, 9498))
...
"}")
        ...
        self.pushButtonAgree = QtWidgets.QPushButton(Dialog)
        self.pushButtonAgree.setGeometry(QtCore.QRect(510, 509, 161, 31))
        self.pushButtonAgree.setStyleSheet("QPushButton{\n"
...
"    color: rgb(60, 96, 255)\n"
"}")
        self.pushButtonAgree.setObjectName("pushButtonAgree")
        self.pushButtonDeny = QtWidgets.QPushButton(Dialog)
        self.pushButtonDeny.setGeometry(QtCore.QRect(290, 509, 201, 31))
        self.pushButtonDeny.setStyleSheet("QPushButton{\n"
"    background-color: rgb(255, 254, 226);\n"
"    border-radius: 0px;\n"
"    color: black;\n"
"    border: 1px dotted rgb(60,96,255)\n"
...
"}")
        ...
        self.label_4.setGeometry(QtCore.QRect(10, 510, 141, 31))
...
"}")
    ...
    def retranslateUi(self, Dialog):
        ...
        self.label_3.setText(_translate("Dialog", "MICROSOFT SOFTWARE LICENSE TERMS\n"
"\n"
...
"\n"
"THIS PRODUCT IS LICENSED UNDER THE AVC, THE VC-1, AND THE MPEG-4 PART 2 VISUAL PATENT PORTFOLIO LICENSES FOR THE PERSONAL AND NON-COMMERCIAL USE OF A CONSUMER TO (i) ENCODE VIDEO IN COMPLIANCE WITH THE ABOVE STANDARDS (“VIDEO STANDARDS”) AND/OR (ii) DECODE AVC, VC-1, AND MPEG-4 PART 2 VIDEO THAT WAS ENCODED BY A CONSUMER E"))
        self.pushButtonAgree.setText(_translate("Dialog", "I Agree the License Terms"))
        self.pushButtonDeny.setText(_translate("Dialog", "I do not agree the license terms"))
